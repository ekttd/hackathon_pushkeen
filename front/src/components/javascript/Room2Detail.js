            ...
            {showDetails && (
                <div className="details-overlay-2">
                    ...
                    <div className="details-content-2">
                        <p>Добро пожаловать в музыкальную гостиную усадьбы
                            прадеда великого поэта Александра Сергеевича Пушкина.
                            Эта комната была центром культурной жизни семьи, где
                            часто устраивались музыкальные вечера и литературные чтения.
                            Перед вами старинный рояль, изготовленный в конце XVIII века,
                            на котором, возможно, играли классические произведения того времени.
                            Рояль украшен изящной резьбой и инкрустацией, отражающей высокий статус
                            семьи. Подсвечник на рояле создавал мягкое освещение для уютных вечеров,
                            наполненных музыкой и творческим общением.</p>
