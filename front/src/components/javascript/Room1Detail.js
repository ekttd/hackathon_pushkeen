...
function Room1Detail() {
    ...
    return (
        <div className="room-detail-container">
            ...
            {isBalalaVisible ? (
                <>
                    <div className="large-text-rectangle-1">Домашний уют</div>
            ...
            {showDetails && (
                ...
                зелеными подушками, отражающие стиль и комфорт той эпохи. Домра на диване напоминает о любви
                            ...
                            атмосферу уюта и спокойствия, где проводились часы за чтением, рукоделием и беседами.</p>
                    </div>
                </div>
            )}
        </div>
